...
GH_REPO="https://github.com/jckuester/awsweeper"
TOOL_NAME="awsweeper"
TOOL_TEST="awsweeper --version"
...
# NOTE: You might want to remove this if awsweeper is not hosted on GitHub releases.
